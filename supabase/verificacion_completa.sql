...
BEGIN
  ...
  -- Verificar campo marca en productos
  ...
  -- Verificar campo rol en profiles
...
BEGIN
  ...
  -- Verificar que productos Qualipharm usen proveedor Qualipharm
...
BEGIN
  ...
  -- Verificar que no haya nombres con "Quali"
...
BEGIN
  ...
  -- Verificar que existe el proveedor Qualipharm
...
BEGIN
  ...
  -- Verificar que RLS esté habilitado en tablas principales usando pg_tables
