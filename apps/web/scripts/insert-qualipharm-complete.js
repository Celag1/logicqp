...
async function insertQualipharmComplete() {
  console.log('🇪🇨 Insertando datos completos de Qualipharm Ecuador...');
  ...
  try {
    ...
    // 5. Insertar categorías farmacéuticas
    console.log('📂 Insertando categorías farmacéuticas...');
    const categorias = [
      { id: 1, nombre: 'Antibióticos', descripcion: 'Medicamentos antibióticos para infecciones', activo: true },
      { id: 2, nombre: 'Analgésicos', descripcion: 'Medicamentos para el dolor', activo: true },
      { id: 3, nombre: 'Antiinflamatorios', descripcion: 'Medicamentos antiinflamatorios', activo: true },
      { id: 4, nombre: 'Vitaminas', descripcion: 'Suplementos vitamínicos', activo: true },
      { id: 5, nombre: 'Cardiovasculares', descripcion: 'Medicamentos para el corazón', activo: true },
      { id: 6, nombre: 'Dermatológicos', descripcion: 'Medicamentos para la piel', activo: true },
      { id: 7, nombre: 'Digestivos', descripcion: 'Medicamentos para el sistema digestivo', activo: true },
      { id: 8, nombre: 'Respiratorios', descripcion: 'Medicamentos para el sistema respiratorio', activo: true }
    ];
    ...
    // 6. Insertar productos farmacéuticos de Qualipharm
    ...
    // 7. Insertar lotes de inventario
    console.log('📦 Insertando lotes de inventario...');
    const lotes = [
      { id: 1, producto_id: 1, cantidad_disponible: 200, fecha_vencimiento: '2025-12-31', lote: 'LOT001' },
      { id: 2, producto_id: 2, cantidad_disponible: 300, fecha_vencimiento: '2026-03-15', lote: 'LOT002' },
      { id: 3, producto_id: 3, cantidad_disponible: 500, fecha_vencimiento: '2025-11-30', lote: 'LOT003' },
      { id: 4, producto_id: 4, cantidad_disponible: 150, fecha_vencimiento: '2026-01-20', lote: 'LOT004' },
      { id: 5, producto_id: 5, cantidad_disponible: 120, fecha_vencimiento: '2025-10-15', lote: 'LOT005' },
      { id: 6, producto_id: 6, cantidad_disponible: 80, fecha_vencimiento: '2026-02-28', lote: 'LOT006' },
      { id: 7, producto_id: 7, cantidad_disponible: 200, fecha_vencimiento: '2025-09-30', lote: 'LOT007' },
      { id: 8, producto_id: 8, cantidad_disponible: 60, fecha_vencimiento: '2026-04-10', lote: 'LOT008' }
    ];
